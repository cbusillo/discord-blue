...
class SetupDoodad(commands.Cog):
    ...
    async def sync_command(self, context: Context[BlueBot]) -> None:
    ...
    @checks.has_employee_role()
    async def clear_command(self, interaction: discord.Interaction[BlueBot], scope: str) -> None:
...
class SetupCommands(commands.GroupCog, name="setup"):
    ...
    async def get_employee_role_command(self, interaction: discord.Interaction[BlueBot]) -> None:
        if isinstance(interaction.response, discord.InteractionResponse):
    ...
    async def set_employee_role_command(self, context: discord.Interaction[BlueBot], role: discord.Role) -> None:
    ...
    async def get_doodads_to_load_autocomplete(self, _: discord.Interaction[BlueBot], current: str) -> list[Choice[str]]:
    ...
    async def get_doodads_to_unload_autocomplete(self, _: discord.Interaction[BlueBot], current: str) -> list[Choice[str]]:
        loaded_doodad_names = self.get_loaded_doodads()
        if current:
    ...
    async def list_doodads_command(self, interaction: discord.Interaction[BlueBot]) -> None:
        if isinstance(interaction.response, discord.InteractionResponse):
    ...
    async def list_running_doodads_command(self, interaction: discord.Interaction[BlueBot]) -> None:
        if isinstance(interaction.response, discord.InteractionResponse):
    ...
    async def load_doodad_command(self, interaction: discord.Interaction[BlueBot], doodad_name: str) -> None:
        if isinstance(interaction.response, discord.InteractionResponse):
            await interaction.response.defer()
    ...
    async def unload_doodad_command(self, interaction: discord.Interaction[BlueBot], doodad_name: str) -> None:
        if isinstance(interaction.response, discord.InteractionResponse):
            await interaction.response.defer()
    ...
    async def reload_config_command(self, interaction: discord.Interaction[BlueBot]) -> None:
        if isinstance(interaction.response, discord.InteractionResponse):
            await interaction.response.defer()
